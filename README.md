...
organized by topic area. Each project includes a notebook with a written explanation of
...
- **[Merton Model for Credit Risk, and the LTCM Case](credit-and-fixed-income/merton_credit_risk_and_ltcm.ipynb)**
  ...
  case study on LTCM's 1998 collapse and what its VaR framework got wrong. 
